...
public class DataInitializer implements ApplicationRunner {
    ...
    private static final Long DEFAULT_ORGANIZER_ID = 1L;
    ...
    public void run(ApplicationArguments args) {
        ...
        List<Event> seedEvents = buildSeedEvents(provinces);
    ...
    private List<Event> buildSeedEvents(Map<Integer, Province> provinces) {
